...
#include <openbabel/isomorphism.h> // flamm
#include "openbabel/query.h"	   // flamm
...
void run_cliquer_martin(const graph &P, const neighborhood &N, vector<graph> &MM);
...
vector<OBMol> mcis_cliquer_vector(OBMol mol1, OBMol mol2);
bool are_isomorphic(OBMol mol1, OBMol mol2); // flamm
...
vector<OBMol> mcis_cliquer_vector(OBMol mol1, OBMol mol2)
{
	...
	neighborhood N;
	vector<graph> MM;
	vector<OBMol> results;

	create_modular_product_mcis(mol1, mol2, P, N);
	run_cliquer_martin(P, N, MM);
	for (graph M : MM)
	{
...
// flamm
bool are_isomorphic(OBMol mol1, OBMol mol2)
{
	bool result = false;
	OBIsomorphismMapper::Mappings maps;
	OBQuery *query = CompileMoleculeQuery(&mol2);
	OBIsomorphismMapper *mapper = OBIsomorphismMapper::GetInstance(query);
	mapper->MapAll(&mol1, maps);
	if (maps.size() > 0)
	{
		result = true;
	}
					...
					FOR_BONDS_OF_MOL(v2, mol2)
					{
						if (v2->GetIdx() != v1->GetIdx())
						{
							...
							if (((u1->GetBondOrder() == v1->GetBondOrder() || (u1->IsAromatic() && v1->IsAromatic())) &&
								...
								((u1a->GetIdx() == u2a->GetIdx() && v1a->GetIdx() == v2a->GetIdx() && u1a->GetAtomicNum() == v1a->GetAtomicNum() && u1a->GetFormalCharge() == v1a->GetFormalCharge() && u1a->GetIsotope() == v1a->GetIsotope()) ||
								 (u1a->GetIdx() == u2a->GetIdx() && v1a->GetIdx() == v2b->GetIdx() && u1a->GetAtomicNum() == v1a->GetAtomicNum() && u1a->GetFormalCharge() == v1a->GetFormalCharge() && u1a->GetIsotope() == v1a->GetIsotope()) ||
								 (u1a->GetIdx() == u2a->GetIdx() && v1b->GetIdx() == v2a->GetIdx() && u1a->GetAtomicNum() == v1b->GetAtomicNum() && u1a->GetFormalCharge() == v1b->GetFormalCharge() && u1a->GetIsotope() == v1b->GetIsotope()) ||
								 (u1a->GetIdx() == u2a->GetIdx() && v1b->GetIdx() == v2b->GetIdx() && u1a->GetAtomicNum() == v1b->GetAtomicNum() && u1a->GetFormalCharge() == v1b->GetFormalCharge() && u1a->GetIsotope() == v1b->GetIsotope()) ||

								 (u1a->GetIdx() == u2b->GetIdx() && v1a->GetIdx() == v2a->GetIdx() && u1a->GetAtomicNum() == v1a->GetAtomicNum() && u1a->GetFormalCharge() == v1a->GetFormalCharge() && u1a->GetIsotope() == v1a->GetIsotope()) ||
								 (u1a->GetIdx() == u2b->GetIdx() && v1a->GetIdx() == v2b->GetIdx() && u1a->GetAtomicNum() == v1a->GetAtomicNum() && u1a->GetFormalCharge() == v1a->GetFormalCharge() && u1a->GetIsotope() == v1a->GetIsotope()) ||
								 (u1a->GetIdx() == u2b->GetIdx() && v1b->GetIdx() == v2a->GetIdx() && u1a->GetAtomicNum() == v1b->GetAtomicNum() && u1a->GetFormalCharge() == v1b->GetFormalCharge() && u1a->GetIsotope() == v1b->GetIsotope()) ||
								 (u1a->GetIdx() == u2b->GetIdx() && v1b->GetIdx() == v2b->GetIdx() && u1a->GetAtomicNum() == v1b->GetAtomicNum() && u1a->GetFormalCharge() == v1b->GetFormalCharge() && u1a->GetIsotope() == v1b->GetIsotope()) ||

								 (u1b->GetIdx() == u2a->GetIdx() && v1a->GetIdx() == v2a->GetIdx() && u1b->GetAtomicNum() == v1a->GetAtomicNum() && u1b->GetFormalCharge() == v1a->GetFormalCharge() && u1b->GetIsotope() == v1a->GetIsotope()) ||
								 (u1b->GetIdx() == u2a->GetIdx() && v1a->GetIdx() == v2b->GetIdx() && u1b->GetAtomicNum() == v1a->GetAtomicNum() && u1b->GetFormalCharge() == v1a->GetFormalCharge() && u1b->GetIsotope() == v1a->GetIsotope()) ||
								 (u1b->GetIdx() == u2a->GetIdx() && v1b->GetIdx() == v2a->GetIdx() && u1b->GetAtomicNum() == v1b->GetAtomicNum() && u1b->GetFormalCharge() == v1b->GetFormalCharge() && u1b->GetIsotope() == v1b->GetIsotope()) ||
								 (u1b->GetIdx() == u2a->GetIdx() && v1b->GetIdx() == v2b->GetIdx() && u1b->GetAtomicNum() == v1b->GetAtomicNum() && u1b->GetFormalCharge() == v1b->GetFormalCharge() && u1b->GetIsotope() == v1b->GetIsotope()) ||

								 (u1b->GetIdx() == u2b->GetIdx() && v1a->GetIdx() == v2a->GetIdx() && u1b->GetAtomicNum() == v1a->GetAtomicNum() && u1b->GetFormalCharge() == v1a->GetFormalCharge() && u1b->GetIsotope() == v1a->GetIsotope()) ||
								 (u1b->GetIdx() == u2b->GetIdx() && v1a->GetIdx() == v2b->GetIdx() && u1b->GetAtomicNum() == v1a->GetAtomicNum() && u1b->GetFormalCharge() == v1a->GetFormalCharge() && u1b->GetIsotope() == v1a->GetIsotope()) ||
								 (u1b->GetIdx() == u2b->GetIdx() && v1b->GetIdx() == v2a->GetIdx() && u1b->GetAtomicNum() == v1b->GetAtomicNum() && u1b->GetFormalCharge() == v1b->GetFormalCharge() && u1b->GetIsotope() == v1b->GetIsotope()) ||
								 (u1b->GetIdx() == u2b->GetIdx() && v1b->GetIdx() == v2b->GetIdx() && u1b->GetAtomicNum() == v1b->GetAtomicNum() && u1b->GetFormalCharge() == v1b->GetFormalCharge() && u1b->GetIsotope() == v1b->GetIsotope()) ||
				...
				if (u2->GetIdx() > u1->GetIdx())
				{
					FOR_ATOMS_OF_MOL(v2, mol2)
					{
						if (v2->GetIdx() != v1->GetIdx())
						{
							...
							if (u1->GetAtomicNum() == v1->GetAtomicNum() && u2->GetAtomicNum() == v2->GetAtomicNum() && u1->GetFormalCharge() == v1->GetFormalCharge() && u2->GetFormalCharge() == v2->GetFormalCharge() && u1->GetIsotope() == v1->GetIsotope() && u2->GetIsotope() == v2->GetIsotope() && ((u1u2 != NULL && v1v2 != NULL && (u1u2->GetBondOrder() == v1v2->GetBondOrder() || (u1u2->IsAromatic() && v1v2->IsAromatic()))) || (u1u2 == NULL && v1v2 == NULL)))
							{
								graph n1 = N[make_pair(u1->GetIdx(), v1->GetIdx())];
								n1.insert(make_pair(u2->GetIdx(), v2->GetIdx()));
								N[make_pair(u1->GetIdx(), v1->GetIdx())] = n1;
	...
	for (graph::iterator i = M.begin(); i != M.end(); i++)
		for (graph::iterator j = M.begin(); j != M.end(); j++)
			if (j->first > i->first)
			{
				...
				if (ab != NULL && cd != NULL && nm == NULL && (ab->GetBondOrder() == cd->GetBondOrder() || (ab->IsAromatic() && cd->IsAromatic())))
				{
